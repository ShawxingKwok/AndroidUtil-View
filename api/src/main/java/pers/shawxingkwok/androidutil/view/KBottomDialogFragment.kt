 ...
 */
public abstract class KBottomDialogFragment<VB: ViewBinding>(private val bindingKClass: KClass<VB>) : Fragment() {
        ...
        object  : ReadWriteProperty<KFragment<VB>, T> {
            ...
            private fun requireSafe(prop: KProperty<*>){
                require(t != UNINITIALIZED){
                    "Call ${this@KBottomDialogFragment.javaClass.canonicalName}.${prop.name} between " +
